...
export function Avatar({ id, size = '' }) { const person = employee(id); return <span className={`avatar ${size}`} title={person?.name || 'Не назначен'}>{person?.initials || '—'}</span>; }
