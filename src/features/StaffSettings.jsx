...
export function EmployeeForm({ person, onSubmit, onClose }) {
  return <SettingsForm onClose={onClose} onSubmit={(data) => onSubmit({ name: data.get('name'), role: data.get('role'), department: data.get('department'), phone: data.get('phone'), email: data.get('email'), notes: data.get('notes'), avatar: data.get('avatar'), active: data.has('active') })}>
